...
VALUES ('2026-01-10', 500000),  -- R$ 5.000,00
    ('2026-01-20', 300000),     -- R$ 3.000,00
    ('2026-02-05', 400000),     -- R$ 4.000,00
    ('2026-02-15', 200000),     -- R$ 2.000,00
    ('2026-03-12', 1000000),    -- R$ 10.000,00
    ('2026-04-01', 1200000),    -- R$ 12.000,00
    ('2026-04-20', 800000);     -- R$ 8.000,00
...
SELECT f.mes AS "Mês",
    ...
    ROUND((f.total_mes_cents - m.media_anual_cents) / 100.0, 2) AS "Variação"
