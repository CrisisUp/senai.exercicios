...
CREATE TABLE IF NOT EXISTS itens_pedido (
    ...
    -- Guardião Financeiro: Centavos inteiros
...
VALUES (1, 'Bateria Lipo 4S', 45000, 10),
    -- R$ 450,00
    (1, 'Hélice Carbono', 8500, 20),
    -- R$ 85,00
    (2, 'Sensor GPS', 120000, 2),
    -- R$ 1200,00
    (3, 'Câmera Térmica', 350000, 1),
    -- R$ 3500,00
    (3, 'Frame 250mm', 22000, 5),
    -- R$ 220,00
    (4, 'Antena Long Range', 35000, 2),
    -- R$ 350,00
    (4, 'Cabo RF', 4500, 10),
    -- R$ 45,00
    (5, 'Kit Calibragem', 150000, 1),
    -- R$ 1500,00
    (5, 'Motor Brushless', 55000, 4),
    -- R$ 550,00
    (1, 'Carregador Balanceado', 25000, 2);
-- R$ 250,00
-- ==============================================================================
