...
int main()
{
    ...
    cout << "===============================================" << endl;
    cout << UI::RESET << "Seu IMC atual é    : " << UI::AMARELO << imc << UI::RESET << endl;
    cout << "Meta de Água/Dia   : " << UI::AZUL << litrosAgua << " Litros" << UI::RESET << endl;
    cout << "-----------------------------------------------" << endl;
    cout << UI::CIANO << "DICA: Mantenha-se sempre hidratado!" << endl;
    cout << "===============================================" << UI::RESET << endl;
