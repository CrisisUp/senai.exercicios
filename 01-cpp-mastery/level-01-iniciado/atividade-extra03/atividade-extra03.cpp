...
int main()
{
    ...
    cout << UI::NEGRITO << "      MONITORAMENTO DE PRODUÇÃO LEITEIRA       " << UI::RESET << endl;
    cout << UI::CIANO << "===============================================" << UI::RESET << endl;
    ...
    cout << "\n--- " << UI::AMARELO << "REGISTRO DE PRODUÇÃO DIÁRIA" << UI::RESET << " ---" << endl;
    ...
    cout << UI::NEGRITO << "          RELATÓRIO DE DESEMPENHO              " << UI::RESET << endl;
    cout << UI::CIANO << "===============================================" << UI::RESET << endl;
    ...
    for (int i = 0; i < numVacas; i++)
    {
        ...
        {
            cout << UI::VERMELHO << " [ALERTA: DESEMPENHO BAIXO]" << UI::RESET;
        }
        else 
        {
