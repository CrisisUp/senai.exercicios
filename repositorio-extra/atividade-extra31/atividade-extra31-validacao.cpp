...
public:
    ...
    T lerDado(const string& mensagem) {
        T dado;
        while (true) {
            cout << UI::BRANCO << mensagem << UI::RESET;
            if (cin >> dado) {
...
int main()
{
    ...
    cout << "===============================================" << UI::RESET << endl;
    cout << UI::BRANCO << "OPERADOR   : " << UI::RESET << UI::NEGRITO << codinome << UI::RESET << endl;
    cout << UI::BRANCO << "NÍVEL      : " << UI::RESET << nivel << endl;
    cout << UI::BRANCO << "TELEMETRIA : " << UI::RESET << fixed << setprecision(2) << frequencia << " GHz (Stable)" << endl;
